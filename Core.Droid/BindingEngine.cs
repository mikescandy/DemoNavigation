...
//        public static void Initialize<TViewModel>(ActivityBase<TViewModel> bindingActivity, int resourceId) where TViewModel : IControllerBase
//        {
...
//            var viewLayoutResourceId = resourceId;// (int)viewLayoutResourceIdProperty.GetValue(bindingActivity);
